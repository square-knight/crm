...
import com.huahua.crm.mapper.CustomerLossMapper;
import com.huahua.crm.mapper.CustomerMapper;
import com.huahua.crm.service.ICustomerLossService;
...
public class CustomerLossServiceImpl implements ICustomerLossService {
	...
	public List<CustomerLoss> selectByCustomerLossExampleByPager(CustomerLoss customerLoss, Pager pager, User user) {
		...
		if(customerIds.size() > 0) {
			CustomerLossExample.Criteria criteria = customerLossExample.createCriteria();
